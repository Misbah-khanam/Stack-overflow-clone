...
import downVoteslogo from "../../assets/down-votes.svg"
import upVoteslogo from "../../assets/up-votes.svg"
                                        ...
                                        <section className='question-details-container'>
                                            ...
                                            <div className='question-details-container-2'>
                                                <div className='question-votes'>
                                                    <img src={upVoteslogo} alt="" width='18' className='votes-icon' onClick={handleUpVote} />
                                                    <p>{question.upVote.length - question.downVote.length}</p>
                                                    <img src={downVoteslogo} alt="" width='18' className='votes-icon' onClick={handleDownVote}/>
                                                </div>
                                                <div style={{width: "100%"}}>
